...
export type TranslationKey =
  ...
  | 'gameMode.headerTitle'
  | 'gameMode.headerSubtitle'
  | 'gameMode.allModes.label'
  | 'gameMode.allModes.desc'
  | 'gameMode.startCta'
  | 'gameMode.wyr.label'
  | 'gameMode.mlt.label'
  ...
  | 'passPhone.shotTakenCardTitle'
  | 'passPhone.shotTakenCardSubtitle'
